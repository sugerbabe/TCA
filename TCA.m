...
%%%%% lambda       :    regularization parameter   迁移参数
%%%%% dim          :    dimensionality after adaptation (dim <= n_feature) 迁移后的维度
%%%%% kernel_tpye  :    kernel name, choose from 'primal' | 'linear' |'rbf' 选择的核函数的类型，原始核则不进行转换
%%%%% gamma        :    bandwidth for rbf kernel, can be missed for other kernels 高斯核的参数
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	%% Set options
	lambda = 1
% The is the implementation of Transfer Component Analysis.ptions.lambda;              
	dim = options.dim;                    
